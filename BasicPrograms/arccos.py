...
print("arccos using CORDIC:", arccos(x_value, 30), math.degrees(arccos(x_value, 30)))


# Przykład użycia
# Example usage
# x = -0.9
# arccos_value = arccos(x, 1)
# print(f'should be {x}, {math.degrees(math.acos(x))}')
# print("arccos({}) = {} radians".format(x, arccos_value))
# print("arccos({}) = {} degrees\n".format(x, math.degrees(arccos_value)))
#
# x = 0.5
# arccos_value = arccos(x, 1)
# print(f'should be {x}, {math.degrees(math.acos(x))}')
